    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shire_name', models.CharField(blank=True, max_length=40, null=True, verbose_name='Local Government')),
                ...
                ('parcel_type', models.CharField(blank=True, max_length=24, null=True)),
                ('cover_type', models.CharField(blank=True, max_length=10, null=True)),
                ('accuracy_code', models.CharField(blank=True, max_length=40, null=True)),
